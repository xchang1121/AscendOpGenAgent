...
# Re-export the per-dtype tolerance lookup from skill verify.
...
def _check_one_tensor(ref, new, idx: int, diagnostics: list) -> tuple:
    ...
    # bool / int / all-non-finite cases: 0.0 for exact-comparison dtypes,
    # None when there's nothing finite to measure.
